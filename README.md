...
Create a project and its persistent launcher from the repository root. The command below creates a
project named `Personal Notes` outside the checkout, uses port `4173`, builds the workspace once,
and writes `launchers/personal-notes.sh`:
